    ...
    try {
        ...
        if(type === 'bullish') {
            ...
            if(data[data.length - 2].close < data[data.length - 2].open
                ...
                bullish_signal = true;         
                // const temp_support = Math.min(data[data.length - 2].close, data[data.length - 1].open);
            ...
            if(data[data.length - 2].close > data[data.length - 2].open
                ...
                bearish_signal = true;
                // const temp_resistance = Math.max(data[data.length - 2].close, data[data.length - 1].open);
