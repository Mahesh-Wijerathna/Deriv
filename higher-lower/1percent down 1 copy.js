    ...
    if (!intervalId) {
        intervalId = setInterval(() => {
            ...
            if(slope1 > 0 && slope2 > 0){
                // console.log("Slope is up");
            }
            else{
                // console.log("Slope is not up");
                return
            }
            ...
            if(curve > 0.01){
                ...
                console.log("Curve is up");
                if( document.getElementById("dt_barrier_1_input").value == "-0.5"){
                        document.getElementById("dt_purchase_call_button").click();
